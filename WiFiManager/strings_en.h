...
const char HTTP_FORM_WIFI[]        PROGMEM = "<label for='s'>SSID</label><input id='s' name='s' maxlength='32' autocorrect='off' autocapitalize='none' placeholder='{v}'><br/><label for='p'>Password</label><input id='p' name='p' maxlength='64' type='password' placeholder='{p}'><br/><input type='checkbox' onclick='myFunction()' style='width:inherit;'>Show Password<script>function myFunction() {var x = document.getElementById('p');if (x.type === 'password') {x.type = 'text';} else {x.type = 'password';}}</script>";
...
const char HTTP_HELP[]             PROGMEM =
 ...
 "</table>"
 "<p/>Github <a href='https://autentik.co.id'>https://autentik.co.id</a>.";
#else
const char HTTP_HELP[]             PROGMEM = "";
#endif
...
#ifdef ESP32
	const char HTTP_INFO_esphead[]    PROGMEM = "<h3>Xtenta</h3><hr><dl>";
...
#else
	const char HTTP_INFO_esphead[]    PROGMEM = "<h3>Ytenta</h3><hr><dl>";
...
const char HTTP_INFO_aboutver[]     PROGMEM = "<dt>Autetik WiFi Set</dt><dd>{1}</dd>";
const char HTTP_INFO_aboutarduino[] PROGMEM = "<dt>Type</dt><dd>{1}</dd>";
const char HTTP_INFO_aboutsdk[]     PROGMEM = "<dt>ESP-SDK/IDF</dt><dd>{1}</dd>";
const char HTTP_INFO_aboutdate[]    PROGMEM = "<dt>Build Date</dt><dd>{1}</dd>";

const char S_brand[]              PROGMEM = "Autentik WiFi Config";
